		...
		<div class="transfer">
			<form action="changePass">
				...
				<span style="font-size: 18px;">NEW PASSWORD:</span>
					<input type="password" name="newP" id="fname" placeholder="Enter New Password..." required><br>
				
				<span style="font-size: 18px;">CONFIRM NEW PASSWORD:</span>
					<input type="password" name="confirmP" placeholder="Re-Enter Password.." required> <br>
