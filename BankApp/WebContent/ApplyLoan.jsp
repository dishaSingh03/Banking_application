...
<title>Bank App</title>
	...
	<body>
		...
		<div class="logo"></div>
		<h2><% out.println("Welcome "+session.getAttribute("name")); %> </h2>	
		

		<div class="bottom"> 
		
		 <a href="homeLoan.jsp" class="button">HOME LOAN</a> 
		
		 <a href="homeLoan.jsp" class="button">CAR LOAN</a> <br>

		 <a href="homeLoan.jsp" class="button">PERSONAL LOAN</a>	

 		 <a href="homeLoan.jsp" class="button">EDUCATION LOAN</a> 
 		 </div>
	</body>
	</html>